...
StydeNet/teachme private

teachme/database/seeds/BaseSeeder.php
@sileence sileence on 6 Apr Adding a dynamic user FK to the ticket table seeder

1 contributor
69 lines (54 sloc) 1.719 kB
<?php
